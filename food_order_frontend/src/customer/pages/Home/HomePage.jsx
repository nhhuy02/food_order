...
import "./HomePage.css";
import MultipleItemsCarousel from "../../component/MultiItemCarousel/MultiItemCarousel";
import RestaurantCard from "../../component/RestaurantCard/RestaurantCard";
import { useDispatch, useSelector } from "react-redux";
import { getAllRestaurantsAction } from "../../../State/Customer/Restaurant/restaurant.action";
    ...
    <div className="">
      <section className="-z-50 banner relative flex flex-col justify-center items-center">
        <div className="w-[50vw] z-10 text-center">
          <p className="text-2xl lg:text-7xl font-bold z-10 py-5">Yum Food</p>
